...
namespace Sloong
{
	namespace Universal
	{
		...
		public:
			...
			static int CompressBlowfish(const char * strsrc, char szDestStr[], string* log = NULL);
			static int UncompressBlowfish(const char * strsrc, char szDestStr[], int nSizeSrc);
