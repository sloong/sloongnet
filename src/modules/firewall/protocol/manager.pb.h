...
class ReportLoadStatusRequest;
class ReportLoadStatusRequestDefaultTypeInternal;
extern ReportLoadStatusRequestDefaultTypeInternal _ReportLoadStatusRequest_default_instance_;
...
template<> ::Manager::ReportLoadStatusRequest* Arena::CreateMaybeMessage<::Manager::ReportLoadStatusRequest>(Arena*);
...
const Functions Functions_MIN = ManagerInvalidFunction;
const Functions Functions_MAX = ReportLoadStatus;
...
class ReportLoadStatusRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Manager.ReportLoadStatusRequest) */ {
 public:
  ReportLoadStatusRequest();
  virtual ~ReportLoadStatusRequest();

  ReportLoadStatusRequest(const ReportLoadStatusRequest& from);

  inline ReportLoadStatusRequest& operator=(const ReportLoadStatusRequest& from) {
    CopyFrom(from);
    return *this;
  }
  #if LANG_CXX11
  ReportLoadStatusRequest(ReportLoadStatusRequest&& from) noexcept
    : ReportLoadStatusRequest() {
    *this = ::std::move(from);
  }

  inline ReportLoadStatusRequest& operator=(ReportLoadStatusRequest&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  #endif
  static const ::google::protobuf::Descriptor* descriptor();
  static const ReportLoadStatusRequest& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const ReportLoadStatusRequest* internal_default_instance() {
    return reinterpret_cast<const ReportLoadStatusRequest*>(
               &_ReportLoadStatusRequest_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    18;

  void Swap(ReportLoadStatusRequest* other);
  friend void swap(ReportLoadStatusRequest& a, ReportLoadStatusRequest& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline ReportLoadStatusRequest* New() const final {
    return CreateMaybeMessage<ReportLoadStatusRequest>(NULL);
  }

  ReportLoadStatusRequest* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<ReportLoadStatusRequest>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
  void CopyFrom(const ReportLoadStatusRequest& from);
  void MergeFrom(const ReportLoadStatusRequest& from);
  void Clear() final;
  bool IsInitialized() const final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(ReportLoadStatusRequest* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return NULL;
  }
  ...
  void set_cpuload(double value);

  // double MemroyUsed = 3;
  void clear_memroyused();
  static const int kMemroyUsedFieldNumber = 3;
  double memroyused() const;
  void set_memroyused(double value);

  // double NetworkIn = 5;
  void clear_networkin();
  static const int kNetworkInFieldNumber = 5;
  double networkin() const;
  void set_networkin(double value);

  // double NetworkOut = 6;
  void clear_networkout();
  static const int kNetworkOutFieldNumber = 6;
  double networkout() const;
  void set_networkout(double value);

  // @@protoc_insertion_point(class_scope:Manager.ReportLoadStatusRequest)
 private:
...
inline ::Base::ResultType PostLogMessageRequest::result() const {
  // @@protoc_insertion_point(field_get:Manager.PostLogMessageRequest.Result)
  return static_cast< ::Base::ResultType >(result_);
}
inline void PostLogMessageRequest::set_result(::Base::ResultType value) {
...
// double CPULoad = 1;
inline void ReportLoadStatusRequest::clear_cpuload() {
  cpuload_ = 0;
}
inline double ReportLoadStatusRequest::cpuload() const {
  // @@protoc_insertion_point(field_get:Manager.ReportLoadStatusRequest.CPULoad)
  return cpuload_;
}
inline void ReportLoadStatusRequest::set_cpuload(double value) {
  
  cpuload_ = value;
  // @@protoc_insertion_point(field_set:Manager.ReportLoadStatusRequest.CPULoad)
}

// double MemroyUsed = 3;
inline void ReportLoadStatusRequest::clear_memroyused() {
  memroyused_ = 0;
}
inline double ReportLoadStatusRequest::memroyused() const {
  // @@protoc_insertion_point(field_get:Manager.ReportLoadStatusRequest.MemroyUsed)
  return memroyused_;
}
inline void ReportLoadStatusRequest::set_memroyused(double value) {
  
  memroyused_ = value;
  // @@protoc_insertion_point(field_set:Manager.ReportLoadStatusRequest.MemroyUsed)
}

// double NetworkIn = 5;
inline void ReportLoadStatusRequest::clear_networkin() {
  networkin_ = 0;
}
inline double ReportLoadStatusRequest::networkin() const {
  // @@protoc_insertion_point(field_get:Manager.ReportLoadStatusRequest.NetworkIn)
  return networkin_;
}
inline void ReportLoadStatusRequest::set_networkin(double value) {
  
  networkin_ = value;
  // @@protoc_insertion_point(field_set:Manager.ReportLoadStatusRequest.NetworkIn)
}

// double NetworkOut = 6;
inline void ReportLoadStatusRequest::clear_networkout() {
  networkout_ = 0;
}
inline double ReportLoadStatusRequest::networkout() const {
  // @@protoc_insertion_point(field_get:Manager.ReportLoadStatusRequest.NetworkOut)
  return networkout_;
}
inline void ReportLoadStatusRequest::set_networkout(double value) {
  
  networkout_ = value;
  // @@protoc_insertion_point(field_set:Manager.ReportLoadStatusRequest.NetworkOut)
}
