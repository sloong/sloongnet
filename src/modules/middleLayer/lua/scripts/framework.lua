...
-- LastEditTime: 2021-04-06 15:12:07
-- LastEditors: Chuanbin Wang
-- FilePath: /service/src/framework.lua
...
-- @return: 
--      bo
Framework.ShowLog = function(msg, title) ShowLog(msg, title) end
...
-- @return: 
--      no
Framework.ReloadScript = function() ReloadScript() end
...
-- @return: 
--      no
Framework.SetCommData = function(key, value) SetCommData(key, value) end
...
--     2 -> error message.
Framework.MoveFile = function(org, new) return MoveFile(org, new) end

-- See SetExtendDataByFile function
Framework.SendFile = function() end


Framework.ReceiveFile = function(save_folder, receive_list) end
Framework.CheckRecvStatus = function() end
Framework.SetExtendData = function() end
Framework.SetExtendDataByFile = function() end
...
-- @return: 
--      1(string) -> the data.
Framework.ConnectToDBCenter = function() end
Framework.SQLQueryToDBCenter = function() end
Framework.SQLInsertToDBCenter = function() end
Framework.SQLDeleteToDBCenter = function() end
Framework.SQLUpdateToDBCenter = function() end
Framework.PrepareUpload = function() end
Framework.UploadEnd = function() end


Framework.GetThumbnail = function() end
...
--
Framework.ConvertImageFormat = function(uuid, target, quality, retain_old_file,
                                        timeout)
    return ConvertImageFormat(uuid, target, quality, retain_old_file, timeout)
end

Framework.SetTimeout = function(t) SetTimeout(t) end
...
-- @return: 
--      no
Framework.PushEvent = function(event, params) PushEvent(event, params) end
