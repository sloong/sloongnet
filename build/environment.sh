...
# @Author: WCB
 ...
 # @LastEditors: WCB
 # @LastEditTime: 2019-12-10 15:04:57
 # @Description: file content
 ###
sudo apt-get update
# install run time library
sudo apt install -y libsqlite3-0 libprotobuf10 libuuid1 libglib2.0-0 libssl1.1 libboost-serialization1.65.1 liblua5.3-0 libjsoncpp1 zip
