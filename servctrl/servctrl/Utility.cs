...
namespace Sloong
{
    public static class Utility
    {
        ...
        /// <returns></returns>  
        public static string[] GetFTPFilePath(string userId, string pwd, string ftpPath)
        {
        ...
        public static void FTPDelete(string userId, string pwd, string ftpPath, string fileName)
        {
            FtpWebRequest reqFTP;
            try
            {
        ...
        //从ftp服务器上下载文件的功能  
        public static void FTPDownload(string userId, string pwd, string ftpPath, string filePath, string fileName)
        {
            FtpWebRequest reqFTP;
            try
            {
